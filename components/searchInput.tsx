...
function SearchInput() {
  ...
  return (
	<div className="flex items-center w-full gap-1 pr-4 mt-4 border rounded-md group focus-within:border-neutral-400 dark:bg-neutral-800 focus-within:outline-4 focus-within:outline-neutral-200 border-neutral-600">
		<Input
			aria-label="Search"
			classNames={{
				inputWrapper: "bg-transparent rounded-md dark:bg-transparent",
				input: "text-sm",
			}}
